...
module DDR_READ_ASYMM_FIFO_DDR_READ_ASYMM_FIFO_0_corefifo_async (
                       rclk,
                       wclk,
                       //reset_rclk,
					   //reset_wclk,
...
endgenerate
   ...
   // --------------------------------------------------------------------------
   DDR_READ_ASYMM_FIFO_DDR_READ_ASYMM_FIFO_0_corefifo_nstagessync #(
   ...
   // --------------------------------------------------------------------------
   DDR_READ_ASYMM_FIFO_DDR_READ_ASYMM_FIFO_0_corefifo_graytobinconv #(
                   .ADDRWIDTH(READ_DEPTH)
                   )
